...
@section('title', 'Tambah Sampah Masuk')
@section('content')
<h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Sampah Masuk/</span> Tambah Sampah Masuk</h4>
                ...
                <div class="col-xxl">
                  <div class="card mb-4">
                    <div class="card-header d-flex align-items-center justify-content-between">
                      <h5 class="mb-0">Tambah Sampah Masuk</h5>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('waste_entries.store') }}" method="POST">
                            ...
                            <a href="{{ route('waste_entries.index') }}"  class="btn rounded-pill btn-danger">Batal</a>
                        </form>
